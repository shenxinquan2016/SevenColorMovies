...
//    CGAffineTransform t = CGAffineTransformMakeRotation([self radiansToDegrees:degrees]);
...
//    return newImage;
    ...
    CGSize rotatedSize = CGSizeMake(self.size.height, self.size.width);
    UIGraphicsBeginImageContext(rotatedSize);
    CGContextRef ctx = UIGraphicsGetCurrentContext();
    CGContextTranslateCTM(ctx, rotatedSize.width / 2, rotatedSize.height / 2);
    CGContextRotateCTM(ctx, M_PI * degrees / 180);
