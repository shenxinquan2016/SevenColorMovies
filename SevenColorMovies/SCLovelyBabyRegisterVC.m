...
- (void)requestRegisterData
{
    ...
    [requestDataManager getRequestJsonDataWithUrl:@"http://192.167.1.6/appjh_mmserver/member/addMember.do" parameters:parameters success:^(id  _Nullable responseObject) {
